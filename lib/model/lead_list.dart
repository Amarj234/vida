...
LeadList leadListFromJson(String str) => LeadList.fromJson(json.decode(str));

String leadListToJson(LeadList data) => json.encode(data.toJson());
...
class LeadList {
  ...
  factory LeadList.fromJson(Map<dynamic, dynamic> json) => LeadList(
        d: D.fromJson(json["d"]),
