...
class OtpScreen extends StatefulWidget {
  const OtpScreen({super.key, required this.mobile, required this.id});
            ...
            children: [
              Column(
                children: [
                  ...
                  //         ? GestureDetector(
                  //             onTap: () {
                  //               // authController.resendCode(widget.mobile);
                  //             },
                  //             child: const Text(
                  //               "Resend Code",
                  //               style: TextStyle(
                  ...
                  //           ),
                  //     // authController.seconds.value != 0
                  //     Text("00:"
                  //         //${authController.seconds.value.toString()}",
                  //         )
                  //   ],
                  // ),
